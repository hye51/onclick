    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
	            <h3 class="mt-4 pt-3 ps-5" style="font-weight:bold">자료 업로드</h3>
					...
					<div class="container-fluid px-4 ">
						...
						<table class="table mx-auto bg-light" style="width:80%">   
							<tbody>
								<tr>
							    	<td scope="row" class="text-secondary" style="border-bottom:0; text-align:left; width:10%">제목</td>
							      	<td colspan="3" style="border-bottom:0; width:90%">
							      		<input class="form-control" name="refSubject" type="text" placeholder="제목을 입력하세요" /> 
									</td>
							    </tr>
							    <tr>
							    ...
							    <tr>
							    	<td colspan="4" style="border-bottom:0"><input type="text" name="refContents" style="width:100%; height:300px; border:0; solid; black"></td>
							    </tr>
							    <tr>
        ...
        <script type="text/javascript">
			function check() {
			var fm= document.frm;
			if(fm.refSubject.value == ""){
				alert("제목을 입력하세요");
				fm.refSubject.focus();
				return false;
			}else if(fm.refContents.value == ""){
				alert("내용을 입력하세요");
				fm.refContents.focus();
				return false;
			}
			
				fm.action="<%=request.getContextPath()%>/refWriteAction.do?lidx=<%=lv.getLidx()%>";
				fm.method = "post";
