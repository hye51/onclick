    ...
    <body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
	            <h3 class="mt-4 pt-3 ps-5" style="font-weight:bold">과제 제출 완료</h3>
            	...
            	<main>
					...
					<div class="container-fluid px-4 ">
						...
						<div class="form-row text-center mb-2">
							<button type="button" class="btn btn-secondary btn-sm" style="width:80px" onclick="<%=request.getContextPath()%>/taskSubmitList.do?tuidx=<%=std.getTuidx()%>">목록</button>
                    	</div>
                	</div>
					<%} %>
                </main>
