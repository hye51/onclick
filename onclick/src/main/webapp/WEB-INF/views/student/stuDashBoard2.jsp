            ...
            <!-- heyri1019 alarm -->
          	...
          	<div class="dropdown">
				...
				<%for(NoticeVO nv : alarm){ %>
						<%if(nv.getCidx()!=0){ %>
						<a id ="alarm" class="dropdown-item d-flex align-items-center list-group-item-action list-group-item" href="<%=request.getContextPath()%>/stuLecContent.do?sidx=<%=nv.getSidx()%>&cidx=<%=nv.getCidx()%>">
							<input type="hidden" value="<%=nv.getNidx()%>" id="nidx">
							<div class="mr-3">
                        ...
                        <div class="small text-gray-500">강좌
                        	<%if(nv.getNcheck().equals("N")){ %>
                        	 ...
                        	 <%} else{ %>
                        	 <span style="float:right;">읽음</span>
                        	 <%} %>
                         </div>
