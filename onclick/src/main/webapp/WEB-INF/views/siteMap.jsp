                ...
                <!-- 여기부터 수정하기. -->
                    <div class="container-fluid px-4">
                        <div class="btn-Mypage">
						  <a class="btn btn-primary active" aria-current="page">My page</a>
						...
						<div class="btn-stuLec">
						  <a class="btn btn-primary active" aria-current="page">학생 강의</a>
						  <a href="<%=request.getContextPath()%>/lecture/lecHome.do" class="btn btn-primary">강의실</a>
